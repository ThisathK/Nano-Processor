...
HD_PWD='C:/Users/Kaveen/Documents/CSE/SEM 2/CS1050 - Computer Oranization and Digital Design/Microprocessor/repo/Nano-Processor/Program_ROM/Program_ROM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Program_ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Program_ROM.tcl
