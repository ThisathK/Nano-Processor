...
HD_PWD='C:/Users/Kaveen/Documents/CSE/SEM 2/CS1050 - Computer Oranization and Digital Design/Microprocessor/repo/Nano-Processor/Instruction_Decoder/Instruction_Decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Inst_Decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Inst_Decoder.tcl
