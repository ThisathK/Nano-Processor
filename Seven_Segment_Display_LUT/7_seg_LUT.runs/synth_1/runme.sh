...
HD_PWD='C:/Users/Kaveen/Documents/CSE/SEM 2/CS1050 - Computer Oranization and Digital Design/Microprocessor/repo/Nano-Processor/Seven_Segment_Display_LUT/7_seg_LUT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_seg_LUT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Seven_seg_LUT.tcl
